...
const Dashboard = {
  ...
  renderSidebar() {
    ...
    const navItems = [
      ...
      { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="7" r="4"/><path d="M2 21v-2a7 7 0 0 1 14 0v2M19 8v6M16 11h6"/></svg>', label: 'Técnicos', href: 'tecnicos.html', active: currentPath === 'tecnicos.html' },
